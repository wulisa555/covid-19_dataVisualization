    ...
    var option = {
        ...
        visualMap: {
            ...
            pieces: [
                ...
                { min: 1, max: 499, label: '1-499', color: '#F0FFFF' },
                { min: 500, max: 4999, label: '500-4999', color: '#E1FFFF' },
                { min: 5000, max: 9999, label: '5000-9999', color: '#AFEEEE' },
                { min: 10000, max: 100000, label: '1万-10万', color: '#5F9EA0' },
                { min: 100000, max: 500000, label: '10万-50万', color: '#008080' },
                { min: 500000, label: '50万以上', color: '#2F4F4F' },
            ],
            itemHeight: 10,
            itemWidth: 10,
            inverse: true,
